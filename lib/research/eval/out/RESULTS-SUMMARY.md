...
- Judge validation: CEO rated the 28-item sample 2026-06-03. Cohen's kappa (n=28): relevance binary(2-vs-<2) k=0.214 / quadratic-weighted k=0.163 (slight-fair); credibility binary k=0.314 / quadratic-weighted k=0.376 (fair). Disagreement is systematic, not noise: (1) relevance ceiling/skew (founder rated 21/28 as relevance 2) deflates kappa; (2) credibility definition gap - founder scores by platform gatekeeping (Wikipedia=1, Reddit=1, Quora/Facebook=0) while the judge is more lenient on user-generated sources. The judge is a directional signal, not a validated expert-credibility proxy. Raw: kappa-ceo-ratings.json, kappa-judge-scores.json, kappa-result.json.
